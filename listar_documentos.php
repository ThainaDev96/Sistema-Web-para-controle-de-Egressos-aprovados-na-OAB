                                                    ...
                                                    <div class="table-responsive dt-responsive">
                                                        <table id="TabelaListaAlunos" class="table table-striped table-bordered nowrap">
                                                            ...
                                                            <tbody>
                                                                <?php
                                                                include 'conexao.php';
                                                                $sql = "SELECT * FROM alunos WHERE doc_oab IS NOT NULL AND doc_oab != ''";
                                                                ...
                                                                if ($result->num_rows > 0) {
                                                                    while($row = $result->fetch_assoc()) {
                                                                        ...
                                                                        echo '<td>
                                                                                <form method="post" action="download_processa.php">
                                                                                    <input type="hidden" name="doc" value="'.$row['doc_oab'].'">
                                                                                    <input type="hidden" name="matricula" value="'.$row['matricula'].'">
                                                                                    <input type="hidden" name="nome" value="'.$row['nome'].'">
                                                                                    <button type="submit" class="btn btn-out btn-primary btn-square">
